...
public class Utils {
	...
	private static final String[] HEX_ARRAY = { "00", "01", "02", "03", "04", "05", "06", "07", "08", "09", "0A", "0B", "0C", "0D", "0E", "0F", "10", "11", "12", "13", "14", "15", "16", "17", "18",
	...
	public static String toHexString(final byte[] bytes) {
		...
		for (final byte b : bytes) {
			builder.append(HEX_ARRAY[b & 0xFF]);
		}
		return builder.toString();
	}

	/**
	 * @return md5 value of the text.
	 */
	public static String md5(final String text) {
		try {
			final MessageDigest digest = MessageDigest.getInstance("MD5");
			final String hashCode = Utils.toHexString(digest.digest(text.getBytes("UTF-8")));
			return hashCode;
		}
